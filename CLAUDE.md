...
- **確認用の URL を毎回書く**: 本番 `https://hassy0511.github.io/train-game/`（1-1）、テストコース `https://hassy0511.github.io/train-game/?stage=0-0`、モデル確認（作った 3D モデルを 1 つずつ回して見る）`https://hassy0511.github.io/train-game/models.html?model=<名前>`。マージ直後は反映まで約 10 分。タイトル画面右下の `build <ID>` で新旧を見分ける
