...
- **確認用の URL を毎回書く**: 本番 `https://hassy0511.github.io/train-game/`（1-1）、テストコース `https://hassy0511.github.io/train-game/?stage=0-0`。マージ直後は反映まで約 10 分。タイトル画面右下の `build <ID>` で新旧を見分ける
