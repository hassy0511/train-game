...
def main():
    ...
    leaf_material = make_material("Leaves", "#2E8B57")

    bpy.ops.mesh.primitive_cylinder_add(vertices=6, radius=0.25, depth=1.2, location=(0.0, 0.0, 0.6))
    trunk = bpy.context.object
    trunk.data.materials.append(trunk_material)

    bpy.ops.mesh.primitive_cone_add(vertices=8, radius1=1.6, radius2=0.0, depth=3.2, location=(0.0, 0.0, 2.6))
