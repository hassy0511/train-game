"""Standing tabby cat (Claude Code).
...
Run: python3 scripts/run-bpy.py assets/blender/cat-stand-k.py
"""
...
def main() -> None:
    ...
    add(tail_paint(TAIL), k.add_swept_tube, "tail", TAIL, [0.029, 0.028, 0.027, 0.027, 0.027, 0.027, 0.026],
