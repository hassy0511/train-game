...
- 状態: **完了**（2026-09-15、コミット b2246c8。PR を経ずに main へ直接 push されたため、Claude Code が事後レビュー: スモーク 4 本通過、ホーム・屋根・看板・ドア帯・乗客・相棒・線路切断の演出を確認）
- 残り: 0003 第 3 弾の木 2 種は未納品（コード側で `tree-a` → `tree-a-proto` の別名で代用中）。0005 の着手時に先に作る
- 担当: Codex
